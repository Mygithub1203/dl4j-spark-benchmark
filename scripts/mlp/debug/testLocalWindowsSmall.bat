...
SET JARARGS=%JARARGS% -dataLoadingMethods SparkBinaryFiles Parallelize -numTestFiles 192 -numParams 100000 -dataSize 128
SET JARARGS=%JARARGS% -miniBatchSizePerWorker 32 -saveUpdater true -repartition Always -repartitionStrategy SparkDefault
