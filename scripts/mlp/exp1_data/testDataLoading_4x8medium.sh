...
JARARGS="$JARARGS -dataLoadingMethods SparkBinaryFiles StringPath Parallelize CSV SequenceFile -numDataSetObjects 6400 -numParams 100000 -dataSize 100 10000"
