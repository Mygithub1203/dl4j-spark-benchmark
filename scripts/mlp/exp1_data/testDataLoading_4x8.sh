...
JARARGS="$JARARGS -dataLoadingMethods SparkBinaryFiles StringPath Parallelize -numDataSetObjects 480 6400 -numParams 100000 -dataSize 100 10000"
...
SPARKARGS="--class org.deeplearning4j.train.RunTrainingTests --num-executors 4 --executor-cores 8 --executor-memory 12G --driver-memory 12G"
